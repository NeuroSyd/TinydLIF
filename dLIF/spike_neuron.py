...
class ActFun_adp(torch.autograd.Function):
    ...
    def backward(ctx, grad_output):  # approximate the gradients
        ...
        return grad_input * temp.float()*gamma #if works better with MG
    
#this is model as adaptive spiking neuron
...
def mem_update_pra(inputs, mem, spike, v_th, tau_m, dt=1,device=None):
    ...
    """   
    alpha = torch.sigmoid(tau_m) #they sigmoid this, this is the alpha parameter which is depending on tau
